...
namespace absyn
{
	...
	public:
		...
		virtual void print(FILE* out, int d) = 0;
		virtual Ty_ty typeCheck(v_tbl venv, t_tbl tenv) const = 0;
	...
	public:
		...
		virtual void print(FILE* out, int d) = 0;
		virtual Ty_ty typeCheck(t_tbl tenv) const = 0;
	...
	public:
		...
		virtual void print(FILE* out, int d) = 0;
		virtual void typeCheck(v_tbl venv, t_tbl tenv) const = 0;
	...
	public:
		...
		void print(FILE* out, int d);
		Ty_ty typeCheck(t_tbl tenv) const;
	...
	public:
		...
		void print(FILE* out, int d);
		void typeCheck(v_tbl venv, t_tbl tenv) const;
